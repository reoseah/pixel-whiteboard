...
export function SelectionIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M1.5 3.5V1.5H3.5M6.5 1.5H9.5M12.5 1.5H14.5V3.5M14.5 6.5V9.5M14.5 12.5V14.5H12.5M9.5 14.5H6.5M3.5 14.5H1.5V12.5M1.5 9.5V6.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
...
export function SelectionReplaceIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M2.5 4.5V3.5C2.5 2.94772 2.94772 2.5 3.5 2.5H4.5M6.5 2.5H9.5M11.5 2.5H12.5C13.0523 2.5 13.5 2.94772 13.5 3.5V4.5M13.5 6.5V9.5M13.5 11.5V12.5C13.5 13.0523 13.0523 13.5 12.5 13.5H11.5M9.5 13.5H6.5M4.5 13.5H3.5C2.94772 13.5 2.5 13.0523 2.5 12.5V11.5M2.5 9.5V6.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
  )
}

export function SelectionUnionIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M4.5 11.5V13.5C4.5 14.0523 4.94772 14.5 5.5 14.5H7.5M4.5 11.5H2.5C1.94772 11.5 1.5 11.0523 1.5 10.5V8.5M4.5 11.5L11.5 4.5M11.5 4.5H13.5C14.0523 4.5 14.5 4.94772 14.5 5.5V7.5M11.5 4.5V2.5C11.5 1.94772 11.0523 1.5 10.5 1.5H8.5M5.5 1.5H2.5C1.94772 1.5 1.5 1.94772 1.5 2.5V5.5M5.5 1.5L1.5 5.5M5.5 1.5H8.5M1.5 5.5V8.5M1.5 8.5L8.5 1.5M10.5 14.5H13.5C14.0523 14.5 14.5 14.0523 14.5 13.5V10.5M10.5 14.5L14.5 10.5M10.5 14.5H7.5M14.5 10.5V7.5M14.5 7.5L7.5 14.5M5 14L14 5M2 11L11 2" stroke="currentColor" stroke-linejoin="round" />
    </svg>
  )
}

export function SelectionSubtractIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M11.5 4.5V2.5C11.5 1.94772 11.0523 1.5 10.5 1.5H8.5M11.5 4.5H13.5C14.0523 4.5 14.5 4.94772 14.5 5.5V6.5M11.5 4.5H8.5M4.5 11.5H2.5C1.94772 11.5 1.5 11.0523 1.5 10.5V8.5M4.5 11.5V13.5C4.5 14.0523 4.94772 14.5 5.5 14.5H6.5M4.5 11.5V8.5M14.5 8.5V10.5M14.5 12.5V13.5C14.5 14.0523 14.0523 14.5 13.5 14.5H12.5M10.5 14.5H8.5M1.5 5.5V2.5C1.5 1.94772 1.94772 1.5 2.5 1.5H5.5M1.5 5.5L5.5 1.5M1.5 5.5V8.5M5.5 1.5H8.5M1.5 8.5L4.5 5.5M8.5 1.5L5.5 4.5M4.5 8.5V5.5M4.5 8.5L2 11M8.5 4.5H5.5M8.5 4.5L11 2M4.5 5.5V5.5C4.5 4.94772 4.94772 4.5 5.5 4.5V4.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
  )
}

export function SelectionIntersectIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M4.5 8.5V5C4.5 4.72386 4.72386 4.5 5 4.5H8.5M4.5 8.5L8.5 4.5M4.5 8.5V11.5M8.5 4.5H11.5M4.5 11.5V13.5C4.5 14.0523 4.94772 14.5 5.5 14.5H6.5M4.5 11.5L11.5 4.5M11.5 4.5H13.5C14.0523 4.5 14.5 4.94772 14.5 5.5V6.5M7.5 11.5H11C11.2761 11.5 11.5 11.2761 11.5 11V7.5M7.5 11.5H2.5C1.94772 11.5 1.5 11.0523 1.5 10.5V9.5M7.5 11.5L11.5 7.5M11.5 7.5V2.5C11.5 1.94772 11.0523 1.5 10.5 1.5H9.5M3.5 1.5H2.5C1.94772 1.5 1.5 1.94772 1.5 2.5V3.5M5.5 1.5H7.5M1.5 5.5V7.5M8.5 14.5H10.5M12.5 14.5H13.5C14.0523 14.5 14.5 14.0523 14.5 13.5V12.5M14.5 10.5V8.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
  )
}

export function SelectionExcludeIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M5.5 1.5H2.5C1.94772 1.5 1.5 1.94772 1.5 2.5V5.5M5.5 1.5L1.5 5.5M5.5 1.5H8.5M1.5 5.5V8.5M1.5 8.5L4.5 5.5M1.5 8.5V10.5C1.5 11.0523 1.94772 11.5 2.5 11.5H7.5M4.5 5.5V5.5C4.5 4.94772 4.94772 4.5 5.5 4.5V4.5M4.5 5.5V8.5M5.5 4.5L8.5 1.5M5.5 4.5H8.5M8.5 1.5H10.5C11.0523 1.5 11.5 1.94772 11.5 2.5V7.5M10.5 14.5H13.5C14.0523 14.5 14.5 14.0523 14.5 13.5V10.5M10.5 14.5L14.5 10.5M10.5 14.5H7.5M14.5 10.5V7.5M11.5 10.5V10.5C11.5 11.0523 11.0523 11.5 10.5 11.5V11.5M11.5 10.5L14.5 7.5M11.5 10.5V7.5M14.5 7.5V5.5C14.5 4.94772 14.0523 4.5 13.5 4.5H11.5H8.5M10.5 11.5L7.5 14.5M10.5 11.5H7.5M7.5 14.5H5.5C4.94772 14.5 4.5 14.0523 4.5 13.5V11.5V8.5M7.5 11.5L5 14M11.5 7.5L14 5M2 11L4.5 8.5M8.5 4.5L11 2" stroke="currentColor" stroke-linejoin="round" />
    </svg>
  )
}